...
dat <- full_join(usbp_00_20_long, usbp_20_23, by=c("fy" = "fiscal_year",
                                                   "cy" = "calendar_year",
                                                   "month" = "month",
                                                   "year_mon" = "year_mon",
                                                   "sector" = "sector")) %>% 
...
stopifnot(sum(dat$diff, na.rm=TRUE) == 0)

dat$value <- coalesce(dat$value.x, dat$value.y)
...
dat <- full_join(usbp_spw_blw, cbp_spw_blw, by=c("cy", "fy", "month")) %>%
